export default [
    ...
    },
    {
        ...
        "aiPromt": "Generate 3 Quora answers in bullet points based on the provided question and context. Provide the result in Rich Text Editor format.",
        "slug": "Add Emoji to outline text depends on outline and rewrite it in rich text editor format",
        "form": [
            {
    ...
    },
    {
        ...
        "aiPromt": "Rewrite give article without any Plagiarism in rich text editor format",
    ...
    {
        "name": "Text Improver",
        "desc": "his handy tool refines your writing, eliminating errors and redundancies for a clear, readable result. It also offers a comprehensive tone analysis and suggests better word choices.",
        "category": "Writing Assistant",
        "icon": "https://cdn-icons-png.flaticon.com/128/1686/1686815.png",
        "aiPromt": "Given textToImprove, Rewrite text without any grammar mistake and professionally in rich text editor format",
        "slug": "text-improver",
        "form": [
            {
